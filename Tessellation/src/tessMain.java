...
public class tessMain implements GLEventListener, KeyListener
{
	...
	public void createNewShape()
	{
        ...
        {
            case CUBE: 
                myShape.makeCube (division1); 
                break;
                
            case CYLINDER: 
                myShape.makeCylinder (0.5f, division1, division2); 
                break;
                
            case CONE: 
                myShape.makeCone (0.5f, division1, division2); 
                break;
                
            case SPHERE: 
                myShape.makeSphere (0.5f, division1, division2); 
                break;
